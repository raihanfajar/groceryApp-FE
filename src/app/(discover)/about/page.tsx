              ...
              <article className="space-y-10 text-justify leading-relaxed">
                ...
                <header>
                  ...
                  <p>
                    ...
                    other platforms, FreshNear is subsidized by the government
                    as part of the{" "}
                ...
                <section>
                  ...
                  <ul className="list-disc space-y-2 pl-6">
                    ...
                    <li>
                      <strong>Instant Delivery:</strong> Available if the
                      selected store is within 2 km of your delivery address.
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Scheduled Delivery:</strong> Plan your groceries
                      at your convenience.
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc space-y-2 pl-6">
                    ...
                    <li>
                      <strong>Daily farm-fresh produce:</strong> All products
                      are sourced and delivered within 24 hours of harvest.
                    </li>
                    <li>
                ...
                <footer>
                  ...
                  <p>
                    ...
                    affordable. FreshNear makes every day easier, one basket at
                    a time!
                  </p>
                </footer>
              </article>
